...
<body>
    <div id="watermark">
        <img src="<?php echo e(public_path() . '/assets/hotel_template.jpg'); ?>" height="100%" width="100%" />
    </div>
            ...
            <table class="header-table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php echo e($data->product->name ? $data->product->name : '-'); ?>
                    ...
                    <tr>
                        ...
                        <td style="width:70%;font-size:13px;font-weight:bold;padding-bottom:12px!important">
                        <?php echo e(Carbon\Carbon::parse($data->checkin_date)->format('d F Y')); ?> 
                        </td>
                    </tr>
                    <td style="width:30%;font-size:13px;padding-bottom:12px!important">Check-Out:
                        </td>
                        <td style="width:70%;font-size:13px;font-weight:bold;padding-bottom:12px!important">
                        <?php echo e(Carbon\Carbon::parse($data->checkout_date)->format('d F Y')); ?>
...
<?php /**PATH /var/www/projects/thanywheresale-api/resources/views/pdf/reservation_hotel_receipt.blade.php ENDPATH**/ ?>